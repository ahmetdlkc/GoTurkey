...
class hotel3yildizIzmirpage extends StatefulWidget {
  const hotel3yildizIzmirpage({Key? key}) : super(key: key);

  @override
  State<hotel3yildizIzmirpage> createState() => _hotel3yildizIzmirpageState();
}

class _hotel3yildizIzmirpageState extends State<hotel3yildizIzmirpage> {
  @override
